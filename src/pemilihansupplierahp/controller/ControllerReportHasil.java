    ...
    public void ShowReport() throws SQLException{
        try {
            try {
                ...
                conn = (Connection)DriverManager.getConnection("jdbc:mysql://localhost/db_pemilihansupplierahp", "root", "password*5");
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(ControllerReportHasil.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            nama_file = "src/pemilihansupplierahp/report/ReportHasil.jrxml";
